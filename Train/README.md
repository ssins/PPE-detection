### 1.Download darknet_weights

[GitHub Release](https://github.com/DataXujing/YOLO-V3-Tensorflow/releases/tag/1.0)
put it into `./data/darknet_weights/`
...
put annotation files under ./data/my_data/Annotations directory
put image file under ./data/my_data/JPEGImages directory
...
python data_pro.py
```
Generate train.txt/val.txt/test.txt files under ./data/my_data/label directory.
one row represents one image as `image_index`,`image_absolute_path`, `img_width`, `img_height`,`box_1`,`box_2`,...,`box_n`
...
modify parameters in `arg.py`：

<details>
<summary><mark><font color=darkred>change arg.py</font></mark></summary>
<pre><code>
### Some paths
...
```
python3 test_single_image.py 000002.jpg
```
