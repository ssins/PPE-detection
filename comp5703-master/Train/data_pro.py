...
def data_split(img_path):
    ...
    # To do
    test_part = random.sample(files,int(2302*0.2))

    val_part = random.sample(test_part,int(int(2302*0.2)*0.5))
...
if __name__ == "__main__":
    ...
    # create YOLO V3 datasets
    base_path = os.getcwd()
    data_path = os.path.join(base_path,"data/my_data")  # absolute path
